...
public class BuscaPelServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String genero = request.getParameter("genero"); //REFERENTE DE BUSQUEDA
        List<Pelicula> peliculas = ClientePeliculas.peliculasPorTema(genero);
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<tr style=\"outline: thin solid\">");
            out.println("<th>Titulo</th>"); //AQUI SE AGREGAN MAS DATOS
            out.println("<th>Año</th>");   //AQUI SE AGREGAN MAS DATOS
            out.println("<th>Poster</th>"); //AQUI SE AGREGAN MAS DATOS
            out.println("</tr>");
