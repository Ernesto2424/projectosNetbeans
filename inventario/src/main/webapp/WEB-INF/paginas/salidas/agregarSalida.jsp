...
<div class="modal fade" id="agregarSalidaModal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="${pageContext.request.contextPath}/controlador?accion=insertarSalida" method="POST" class="was-validated">
