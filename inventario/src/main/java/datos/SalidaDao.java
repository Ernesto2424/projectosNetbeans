...
public class SalidaDao implements OperacionesDatos<Object>{
    ...
    private static final String SQL_INSERT = "INSERT INTO salida(fecha, cantidad, codigo_producto) VALUES(?,?,?)";
     ...
     * la base de datos todos los registros del tipo Salida.
     * 
     * @return Lista de objetos del tipo EntradaSalida pero que tienen
     * la función de una Salida del inventario de productos.
     */
    @Override
    public List<Object> SELECT() {
        ...
        PreparedStatement pst = null;
        ResultSet rs = null;
        EntradaSalida salida = null;
        List<Object> salidas = new ArrayList<Object>();
        ...
        try {
            ...
            while(rs.next()){
                ...
                salida = new EntradaSalida(producto, codigo, fecha, cantidad);
                salidas.add(salida);
            }
        } catch (SQLException ex) {
            ex.printStackTrace(System.out);
